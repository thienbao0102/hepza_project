const industryGroups = {
  ...
  "Vật liệu xây dựng, sản xuất gỗ, trang trí nội thất": [
  ...
  "Khác": [
    ...
    "8240 - Hoạt động dịch vụ trung gian cho các hoạt động dịch vụ hỗ trợ kinh doanh",
    ...
    "8412 - Hoạt động quản lý nhà nước trong các lĩnh vực y tế, giáo dục, văn hóa và các dịch vụ xã hội khác",
    ...
    "9529 - Sửa chữa, bảo dưỡng xe đạp, đồng hồ, đồ dùng cá nhân và gia đình khác",
    "9531 - Sửa chữa, bảo dưỡng ô tô và xe có động cơ khác",
    "9532 - Sửa chữa, bảo dưỡng mô tô, xe máy",
    "9540 - Hoạt động dịch vụ trung gian cho sửa chữa, bảo dưỡng",
